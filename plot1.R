##Note: This R script creates the first plot ("Plot 1") of the Coursera Exploratory Data Analysis Course
...
##Create labels for the X axis and for the main title
...
hist(SubsetHousePowerData$Global_active_power, xlab = x_label, 
     col="red", main= main_title)
